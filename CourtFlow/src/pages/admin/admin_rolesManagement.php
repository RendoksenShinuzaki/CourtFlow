...
$loggedInRole = $_SESSION['role'] ?? ''; // Use default empty string if 'role' is not set in the session
...
$currentPage = max(min($totalPages, $currentPage), 1);

// Calculate the SQL limit starting position for the current page
$offset = ($currentPage - 1) * $itemsPerPage;

$sql = "SELECT * FROM roles LIMIT $offset, $itemsPerPage";
$result = $conn->query($sql);
...
<body class="bg-gray-200 h-full">
            ...
            <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-3/4 lg:w-80 sm:max-w-xs pt-6 pb-8 bg-white overflow-y-auto border-l border-gray-400 shadow-2xl">
                ...
                <div class="px-4 pb-6">
                    ...
                    <ul class="text-sm font-medium">
                        ...
                        <li>
                            <a href="admin_casesReturns.php" class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white hover:border border-gray-500 rounded">
                                <span class="inline-block mr-3">
                        ...
                        <li>
                            <a href="admin_auditTrail.php" class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white hover:border border-gray-500 rounded" href="#">
                                <span class="inline-block mr-3">
    ...
    <!-- Add New Role -->
    <section class="py-20 ml-40 mr-5 pl-44">
        <div id="addFormContainer" class="hidden">
            <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                <form class="bg-white p-6 rounded-md" action="../../controller/admin_rolesManagementController.php" method="post">
                    <!--Role-->
                    <div class="mt-2">
                        <label for="addRole" class="text-sm">Role</label>
                        <br />
                        <input required type="text" name="addRole" id="addRole" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <!--Roles checkboxes-->
                    <div class="mt-2">
                        ...
                        <div class="mt-2 flex">
                            <label class="mr-4">
                                <input type="checkbox" name="caseHistory" value="1" /> Case History
                            </label>
                            <label class="mr-4">
                                <input type="checkbox" name="route" value="1" /> Route
                            </label>
                            <label class="mr-4">
                                <input type="checkbox" name="submitCase" value="1" /> Submit Case
                            </label>

                            <label class="mr-4">
                                <input type="checkbox" name="retrievedDocuments" value="1" /> Retrieved Documents
                            </label>

                            <label class="mr-4">
                                <input type="checkbox" name="matrixPenalties" value="1" /> Matrix Penalties
                            </label>
                        </div>
                    </div>
                    <div class="mt-2 flex">
                        ...
                        <label class="mr-4">
                            <input type="checkbox" name="sentCases" value="1" /> Sent Cases
                        </label>
                        ...
                        <label class="mr-4">
                            <input type="checkbox" name="caseAssignment" value="1" /> Case Assignment
                        </label>

                        <label class="mr-4">
                            <input type="checkbox" name="retrievedCases" value="1" /> Retrieved Cases
                        </label>
                    </div>
                    <div class="mt-2 flex">

                        <label class="mr-4">
                            <input type="checkbox" name="warrantArrest" value="1" /> Warrant of Arrest
                        </label>

                        <label class="mr-4">
                            <input type="checkbox" name="archived" value="1" /> Archived
                        </label>

                        <label class="mr-4">
                            <input type="checkbox" name="scheduledHearing" value="1" /> Scheduled Hearing
                        </label>

                        <label class="mr-4">
                            <input type="checkbox" name="documents" value="1" /> Documents
                        </label>

                    </div>
                    <div class="mt-2">
                        <label>
                            <input type="checkbox" name="caseList" value="1" /> Case List
                        </label>
                    </div>
                    <div class="mt-2">
                        <label>
                            <input type="checkbox" name="QRScanner" value="1" /> QR Scanner
                        </label>
                    </div>
                    <!--Save Button-->
                    <div>
                        <button type="submit" name="AddRoleBtn" id="AddRoleBtn" class="mt-10 flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Save
                        </button>
                    </div>
                    <div>
                        <button type="button" name="addCancel" id="addCancel" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Cancel
                        </button>
                    </div>
                </form>
        ...
        <!-- Edit Role -->
        <div id="EditRoleFormContainer" class="hidden">
            <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                <form id="EditRoleForm" class="bg-white p-6 rounded-md" action="../../controller/admin_rolesManagementController.php" method="post">
                    <!--Role-->
                    <input type="hidden" name="id" id="id">
                    <div class="mt-2">
                        <label for="editRole" class="text-sm">Role</label>
                        <br />
                        <input required type="text" name="editRole" id="editRole" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <!--Roles checkboxes-->
                    <div class="mt-2">
                        <label class="text-sm">Roles</label>
                        <br />
                        <label>
                            <input type="checkbox" name="editCaseHistory" value="1" /> Case History
                        </label>
                        <br/>
                        <label>
                            <input type="checkbox" name="editRoute" value="1" /> Route
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editSubmitCase" value="1" /> Submit Case
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editSubmitWarrant" value="1" /> Submit Warrant
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editRetrievedDocuments" value="1" /> Retrieved Documents
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editMatrixPenalties" value="1" /> Matrix Penalties
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editSentCases" value="1" /> Sent Cases
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editInbox" value="1" /> Inbox
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editCaseAssignment" value="1" /> Case Assignment
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editWarrantArrest" value="1" /> Warrant of Arrest
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editArchived" value="1" /> Archived
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editScheduledHearing" value="1" /> Scheduled Hearing
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editDocuments" value="1" /> Documents
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editCaseList" value="1" /> Case List
                        </label>
                        <br />
                        <label>
                            <input type="checkbox" name="editQrScanner" value="1" /> QR Scanner
                        </label>
                    </div>
                    <!--Save Button-->
                    <div>
                        <button type="submit" name="EditRoleBtn" id="EditRoleBtn" class="mt-10 flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Save
                        </button>
                    </div>
                    <div>
                        <button type="button" name="editCancel" id="editCancel" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Cancel
                        </button>
                    </div>
                </form>
        ...
        <div>
            <?php if ($loggedInRole == "superAdmin") : ?>
                <button type="button" id="addButton" class="mt-5 flex justify-center rounded-md bg-gray-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
        ...
        <table class="mt-5 table-auto w-full border-b border-gray-900 bg-gray-600 shadow-2xl rounded-lg">
            <thead class="border-b-2 border-gray-900">
                <tr>
                    <th class="pl-6 py-6">
                        <p class="flex items-center text-xs text-white font-2xl">Roles</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Case History</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Route</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Submit Case</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Submit Warrant</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Retrieved Documents</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Matrix Penalties</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Sent Cases</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Inbox</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Case Assignment</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Warrant of Arrest</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Archived</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Scheduled Hearing</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Documents</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">Case List</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs text-white font-2xl">QR Scanner</p>
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                    <tr class="text-xs bg-blue-50 border-b border-gray-100 edit-trigger">
                        <td class="hidden"><?= $roles['id']; ?></td>
                        <td class="pl-6 py-6 bg-blue-100"><?= $roles['Role']; ?></td>
                        <td class="hidden"><?= $roles['CaseHistory']; ?></td>
                        <td class="hidden"><?= $roles['Route']; ?></td>
                        <td class="hidden"><?= $roles['SubmitCase']; ?></td>
                        <td class="hidden"><?= $roles['SubmitWarrant']; ?></td>
                        <td class="hidden"><?= $roles['RetrievedDocuments']; ?></td>
                        <td class="hidden"><?= $roles['MatrixPenalties']; ?></td>
                        <td class="hidden"><?= $roles['SentCases']; ?></td>
                        <td class="hidden"><?= $roles['Inbox']; ?></td>
                        <td class="hidden"><?= $roles['CaseAssignment']; ?></td>
                        <td class="hidden"><?= $roles['WarrantArrest']; ?></td>
                        <td class="hidden"><?= $roles['Archived']; ?></td>
                        <td class="hidden"><?= $roles['ScheduledHearing']; ?></td>
                        <td class="hidden"><?= $roles['Documents']; ?></td>
                        <td class="hidden"><?= $roles['CaseList']; ?></td>
                        <td class="hidden"><?= $roles['QRScanner']; ?></td>
                        <td class="pl-6 py-6">
                            <?php if ($roles['CaseHistory'] == 0) : ?>
                        ...
                        <td class="pl-6 py-6 bg-blue-100">
                            <?php if ($roles['RetrievedDocuments'] == 0) : ?>
                                <span class="text-red-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                        ...
                        <td class="pl-6 py-6">
                            <?php if ($roles['MatrixPenalties'] == 0) : ?>
                                <span class="text-red-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                        ...
                        <td class="pl-6 py-6">
                            <?php if ($roles['ScheduledHearing'] == 0) : ?>
                                <span class="text-red-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
        ...
        <div class="flex justify-center mt-4">
            <ul class="flex space-x-2">
                <?php if ($currentPage > 1) : ?>
                    <li>
                        <a href="?page=<?= $currentPage - 1 ?>" class="px-3 py-1 bg-gray-200 rounded hover:bg-gray-900 hover:text-white transition-colors duration-300">Previous</a>
                    </li>
                <?php endif; ?>

                <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                    <?php
                    // Define a class for the current page number link
                    $currentPageClass = ($i == $currentPage) ? 'bg-gray-800 text-white' : 'bg-gray-200 hover:bg-gray-900 hover:text-white';
                    ?>
                    <?php if ($i > $currentPage - 3 && $i < $currentPage + 3) : ?>
                        <li>
                            <a href="?page=<?php echo $i; ?>" class="px-3 py-1 rounded transition-colors duration-300 <?php echo $currentPageClass; ?>"><?php echo $i; ?></a>
                        </li>
                    <?php endif; ?>
                <?php endfor; ?>
                ...
                <?php if ($currentPage < $totalPages) : ?>
                    <li>
                        <a href="?page=<?= $currentPage + 1 ?>" class="px-3 py-1 bg-gray-200 rounded hover:bg-gray-900 hover:text-white transition-colors duration-300">Next</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
...
EditRoleBtn.forEach((EditRoleButtons) =>{
    EditRoleButtons.addEventListener("click", () =>{
        ...
        const caseHistory = tableRow.cells[2].textContent;
        const route = tableRow.cells[3].textContent;
        const submitCase = tableRow.cells[4].textContent;
        const submitWarrant = tableRow.cells[5].textContent;
        const retrievedDocuments = tableRow.cells[6].textContent;
        const matrixPenalties = tableRow.cells[7].textContent;
        const sentCases = tableRow.cells[8].textContent;
        const inbox = tableRow.cells[9].textContent;
        const caseAssignment = tableRow.cells[10].textContent;
        const warrantArrest = tableRow.cells[11].textContent;
        const archived = tableRow.cells[12].textContent;
        const scheduledHearing = tableRow.cells[13].textContent;
        const documents = tableRow.cells[14].textContent;
        const caseList = tableRow.cells[15].textContent;
        const qrScanner = tableRow.cells[16].textContent;
        
        editForm.id.value = id;
        editForm.editRole.value = role;
        editForm.editCaseHistory.checked = (caseHistory == 1);
        editForm.editRoute.checked = (route == 1);
        editForm.editSubmitCase.checked = (submitCase == 1);
        editForm.editSubmitWarrant.checked = (submitWarrant == 1);
        editForm.editRetrievedDocuments.checked = (retrievedDocuments == 1);
        editForm.editMatrixPenalties.checked = (matrixPenalties == 1);
        editForm.editSentCases.checked = (sentCases == 1);
        editForm.editInbox.checked = (inbox == 1);
        editForm.editCaseAssignment.checked = (caseAssignment == 1);
        editForm.editWarrantArrest.checked = (warrantArrest == 1);
        editForm.editArchived.checked = (archived == 1);
        editForm.editScheduledHearing.checked = (scheduledHearing == 1);
        editForm.editDocuments.checked = (documents == 1);
        editForm.editCaseList.checked = (caseList == 1);
        editForm.editQrScanner.checked = (qrScanner == 1);
    });
});
...
<!-- <script src="../../javascript/admin_rolesManagement.js"></script> -->