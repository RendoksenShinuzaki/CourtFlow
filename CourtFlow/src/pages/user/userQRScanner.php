...
<div class="hidden lg:block navbar-menu relative z-50">
            ...
            <div class="px-4 pb-6">
                ...
                <ul class="text-sm font-medium">
                    ...
                    <li class="<?php echo ($QRScanner === 0) ? 'hidden' : ''; ?>">
                        <a class="flex items-center pl-3 py-3 pr-2 text-gray-50 bg-gray-900 hover:text-white transition duration-300 border-gray-500 rounded" href="userQRScanner.php">
                            <span class="inline-block mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div class="items-center justify-center min-h-screen">
        <div class="border border-gray-300 rounded-lg p-4 max-w-2xl mx-auto mb-8 bg-white">
            <div id="qr-reader" class="w-full"></div>
        </div>
        <img src="../../images/qrcode.gif" alt="Descriptive Alt Text" class="mx-auto mt-4 max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl w-full" /> <!-- Adjusted image sizing and responsiveness -->
    </div>
</body>
</html>
...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            function onScanSuccess(decodedText, decodedResult) {
                ...
                // Open the scanned QR code directly in the same tab
                window.location.href = decodedText;
            }

            var html5QrcodeScanner = new Html5QrcodeScanner(
                "qr-reader", {
                    fps: 60, // Increase fps value
                    qrbox: 150 // Adjust qrbox size
                });
