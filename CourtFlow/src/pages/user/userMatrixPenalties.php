...
<body class="bg-gray-200">
    ...
    <div class="py-20 ml-40 mr-5 pl-44">
        <div class="flex items-center justify-between">
            ...
            <!-- Add Penalty Button -->
            <button type="button" id="addPenalty" class="mt-5 flex justify-center rounded-md bg-gray-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                Add Penalty
            </button>
        </div>
        <div id="addPenaltyContainer" class="hidden">
            <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                <form id="addForm" class="bg-white p-6 rounded-md" action="../../controller/user_matrixPenaltiesController.php" method="post">
                    <input type="hidden" name="empId" id="empId" value=<?php echo $loggedInEmployeeId; ?>>
                    <div class="mt-2">
                        <label for="addRA" class="text-sm">Republic Act</label>
                        <br />
                        <input required type="number" name="addRA" id="addRA" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <div class="mt-2">
                        <label for="addarticle" class="text-sm">Article</label>
                        <br />
                        <input required type="number" name="addarticle" id="addarticle" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <div class="mt-2">
                        <label for="addsection" class="text-sm">Section</label>
                        <br />
                        <input required type="number" name="addsection" id="addsection" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <div class="mt-2">
                        <label for="addCaseFine" class="text-sm" id="labelAddCaseFine">Case Fine</label>
                        <br />
                        <input required type="number" name="addCaseFine" id="addCaseFine" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <div id="bailable" class="text-sm mb-2">
                        <p class="mt-2">Bailable</p>
                        <input type="radio" name="bailable" value="1" id="YesBailable" class="text-sm mx-1" checked /><label for="Yes">Yes</label>
                        <input type="radio" name="bailable" value="0" id="NoBailable" class="text-sm mx-1" /><label for="No">No</label>
                    </div>
                    <div>
                        <button type="submit" name="addPenalty" id="addPenalty" class="mt-10 flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Save
                        </button>
                    </div>
                    <div>
                        <button type="button" name="cancelPenalty" id="cancelPenalty" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Cancel
                        </button>
                    </div>
                </form>
        ...
        <div id="editFormContainer" class="hidden">
            <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                <form id="editForm" class="bg-white p-6 rounded-md" action="../../controller/user_matrixPenaltiesController.php" method="post">
                    <input type="hidden" name="id" id="id">
                    <div class="mt-2">
                        <label for="editRepublicAct" class="text-sm">Republic Act</label>
                        <br />
                        <input required type="text" name="editRepublicAct" id="editRepublicAct" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <div class="mt-2">
                        <label for="editArticle" class="text-sm">Article</label>
                        <br />
                        <input required type="text" name="editArticle" id="editArticle" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <div class="mt-2">
                        <label for="editSection" class="text-sm">Section</label>
                        <br />
                        <input required type="text" name="editSection" id="editSection" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <div class="mt-2">
                        <label for="editCaseFine" class="text-sm" id="labelEditCaseFine">Case Fine</label>
                        <br />
                        <input required type="number" name="editCaseFine" id="editCaseFine" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                    </div>
                    <div id="bailable" class="text-sm mb-2">
                        <p class="mt-2">Bailable</p>
                        <input type="radio" name="editBailable" value="1" id="editYesBailable" class="text-sm mx-1" checked /><label for="Yes">Yes</label>
                        <input type="radio" name="editBailable" value="0" id="editNoBailable" class="text-sm mx-1" /><label for="No">No</label>
                    </div>
                    <div>
        ...
        <div id="deleteFormContainer" class="hidden">
            <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                <form id="deleteForm" class="bg-white p-6 rounded-md" action="../../controller/user_matrixPenaltiesController.php" method="post">
                    <input type="hidden" name="id" id="id">
                    <a>Are you sure you want to delete?</a>
                    <div>
                        <button type="submit" name="delete" id="delete" class="mt-10 flex w-full justify-center rounded-md bg-red-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            Yes
                        </button>
                    </div>
                    <div>
                        <button type="button" name="deleteCancel" id="deleteCancel" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                            No
                        </button>
                    </div>
                </form>
        ...
        <table class="mt-5 table-auto w-full bg-white rounded">
            <thead class="border-gray-500 shadow-2xl">
                <tr>
                    <th class="pl-6 py-6">
                        <p class="flex items-center text-xs">Republic Act (RA)</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs">Article</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs">Section</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs">Case Fine</p>
                    </th>
                    <th>
                        <p class="flex items-center text-xs">Bailable</p>
                    </th>
                </tr>
            </thead>
            <tbody>
                <?php
                foreach ($penaltiesResult as $penalties) :
                    $bailable = $penalties['Bailable'];
                ?>
                    <tr class="text-xs bg-blue-50 border-b border-gray-100 edit-trigger">
                        <td class="hidden"><?= $penalties['id']; ?></td>
                        <td class="hidden"><?= $penalties['EmployeeId']; ?></td>
                        <td class="pl-6 py-6 bg-blue-100"><?= $penalties['RepublicAct']; ?></td>
                        <td class="pl-6 py-6 "><?= $penalties['Article']; ?></td>
                        <td class="pl-6 py-6 bg-blue-100"><?= $penalties['Section']; ?></td>
                        <td class="pl-6 py-6 "><?= $penalties['CaseFine']; ?></td>
                        <td class="hidden"><?= $penalties['Bailable']; ?></td>
                        <td class="pl-6 py-6 bg-blue-100">
                            <?php if ($bailable == 0) : ?>
                                <span class="text-red-600">
                                    <svg value="0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Get references to the radio buttons and the addCaseFine input field 
        const yesBailableRadio = document.getElementById("YesBailable");
        const noBailableRadio = document.getElementById("NoBailable");
        const addCaseFineInput = document.getElementById("addCaseFine");
        const labelAddCaseFineInput = document.getElementById("labelAddCaseFine");
        const addForm = document.getElementById("addForm");


        // Add an event listener to the radio buttons
        yesBailableRadio.addEventListener("change", function() {
            labelAddCaseFineInput.classList.remove("hidden");
            addCaseFineInput.classList.remove("hidden");
            addCaseFineInput.setAttribute('required', 'required');
        });

        noBailableRadio.addEventListener("change", function() {
            labelAddCaseFineInput.classList.add("hidden");
            addCaseFineInput.classList.add("hidden");
            addCaseFineInput.removeAttribute('required');
            addForm.addCaseFine.value = 0;
        });

        const editYesBailableRadio = document.getElementById("editYesBailable");
        const editNoBailableRadio = document.getElementById("editNoBailable");
        ...
        editYesBailableRadio.addEventListener("change", function() {
        ...
        editNoBailableRadio.addEventListener("change", function() {
...
<script src="../../javascript/user_userMatrixPenalties.js"></script>