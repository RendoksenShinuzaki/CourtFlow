...
$loggedInLastName = $_SESSION['lastName'] ?? '';
$loggedInFirstName = $_SESSION['firstName'] ?? '';
$loggedInMiddleName = $_SESSION['middleName'] ?? '';
$loggedInGender = $_SESSION['gender'] ?? '';
...
$rtcSql = "SELECT * FROM rtc_warrant where isPending = 1 AND FromEmployee = '$loggedInEmployeeId'";
...
<body class="bg-gray-200 h-full overflow-y-hidden">
    <div>
                ...
                <div class="px-4 pb-6">
                    ...
                    <ul class="text-sm font-medium">
                        ...
                        <li class="<?php echo ($SubmitWarrant === 0) ? 'hidden' : ''; ?>">
                            <a class="flex items-center pl-3 py-3 pr-2 text-white bg-gray-900 rounded" href="#">
                                <span class="inline-block mr-3">
                        ...
                        <!-- <li class="<?php echo ($Notification === 0) ? 'hidden' : ''; ?>">
        ...
        <!-- SUBMIT WARRANT -->
        <div class="<?php echo ($loggedInRole === 'RTC') ? '' : 'hidden'; ?> w-full min-h-screen flex">
            <div class="py-10 ml-40 mr-5 pl-44">
                <div class="lg:flex space-x-16 ml-0.5 mr-32">
                    <h1 class="font-bold text-2xl font-serif mb-20">Warrant of Arrest Submission</h1>
                </div>
                <div class="w-full mt-40 mx-auto py-24"> <!-- Adjusted mt-40 to move it down -->
                    <div class="border-gray-500 bg-white rounded-lg px-12 pl-6 pt-16 pb-20 pr-24 flex justify-end items-center shadow-2xl"> <!-- Adjusted pr-24 for right padding -->
                        <form class="my-4 text-sm mr-4 ml-auto" action="../../controller/user_submitWarrantController.php" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="empId" id="empId" value="<?php echo $loggedInEmployeeId; ?>">
                            <!-- Docket Number-->
                            <div class="border bg-gray-500 rounded-lg px-6 mr-32 pb-4"> <!-- Adjusted px-6 for wider border and pb-4 for bottom padding -->
                                <div class="flex flex-col my-4">
                                    <label for="docketNumber" class="text-white font-semibold">Docket Number</label>
                                    <select name="docketNumber" id="docketNumber" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 w-96"> <!-- Adjusted width to w-96 -->
                                        <?php foreach ($rtcResult as $rtcWarrant) : ?>
                                            <option value="<?= $rtcWarrant['id']; ?>"><?= $rtcWarrant['DocketNumber']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <!-- Submit Button -->
                                <div class="my-4 flex items-center justify-center space-x-4">
                                    <button type="submit" name="submitWarrant" id="submitWarrant" class="bg-gray-700 hover:bg-gray-900 rounded-2xl w-full px-8 py-2 text-gray-100 hover:shadow-xl transition duration-150 uppercase font-semibold">Submit</button>
                                </div>
                            </div>

                        </form>
                        <div class="w-full max-w-screen-xl ml-0 lg:mr-auto">
                            <img src="../../images/submitwarrant.gif" alt="Description" class="w-60 h-60 lg:w-96 lg:h-96 xl:w-120 xl:h-120 object-contain mx-auto lg:mx-0 ml-0 mb-4">
                        </div>
                    </div>
                </div>
            </div>
