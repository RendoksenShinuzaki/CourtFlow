...
$branchSql = "SELECT * FROM branches WHERE IsAvailable = '1'";
...
<body class="bg-gray-200">
    ...
    <!--OCC Case Assignment-->
    <div class="md:flex md:justify-center md:space-x-8 lg:space-x-16 md:ml-80"> <!-- Assuming the navbar takes 80px (adjust as needed) -->
        <div class="w-full md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 px-4 md:px-8 lg:px-12 xl:px-16 py-6 md:py-8 relative overflow-hidden">
            <form class="relative z-10 my-4 text-sm lg:flex lg:flex-col" action="../../controller/user_caseAssignmentController.php" method="post" enctype="multipart/form-data">
                <h1 class="font-bold font-serif text-gray-700 text-base md:text-xl lg:text-2xl xl:text-3xl lg:text-left xl:text-left mb-4">Case Assignment</h1>
                ...
                <div class="flex flex-col my-4">
                    ...
                    <input required type="number" name="docketNumber" id="docketNumber" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900" step="1">
                </div>
                <!-- Branch -->
                <div class="flex flex-col my-4">
                    <label for="branch" class="text-gray-700">Branch</label>
                    <select name="branch" id="branch" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900">
                ...
                <!-- Inbox file -->
                <div class="flex flex-col my-4">
                    <label for="inboxFile" class="text-gray-700">Select a file from inbox</label>
                    <select name="inboxFile" id="inboxFile" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900">
                        <?php foreach ($OCCInboxResult as $OCCInbox) : ?>
                            <option value="<?= $OCCInbox['id']; ?>"><?= $OCCInbox['FileName']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="w-full max-w-screen-xl ml-auto lg:mr-auto">
                    <img src="../../images/CaseAss.gif" alt="Description" class="w-100 h-55 lg:w-96 lg:h-50 xl:w-80 xl:h-120 object-contain mx-auto lg:mx-0 ml-20 mb-4">
                </div>
        </div>
        <div class="hidden lg:flex lg:flex-col lg:w-1/2 lg:pl-8 my-14">
            <!--upload file-->
            <!-- mb-8 mt-24 rounded-lg shadow-md bg-white mr-8 -->
            <div class="mb-8 mt-24 rounded-lg shadow-md bg-white mr-4 text-center p-2">
                <label for="file" class="relative flex min-h-[200px] items-center justify-center">
                    <div>
                        ...
                        <span class="py-2 px-7 font-medium underline underline-blue text-gray-800">
                            Browse
                        </span>
                    </div>
                </label>
            ...
            <div class="mr-3.5  flex items-center justify-center space-x-4">
                <button type="submit" name="occSubmit" id="occSubmit" class="bg-gray-700 hover:bg-gray-900 font-semibold rounded-2xl w-full px-8 py-2 text-gray-100 hover:shadow-xl transition duration-150 uppercase">Submit</button>
            </div>
            </form>
        </div>
    </div>
