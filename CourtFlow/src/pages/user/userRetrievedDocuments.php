...
//PAO Cases SQL Query
$PAOSql = "SELECT * FROM v1_pao_submit_case WHERE isReturn = '1' AND isReturnApproved = '1'";
$PAOSqlResult = $conn->query($PAOSql);

//Fiscal Cases SQL Query
$FiscalSql = "SELECT * FROM v2_fiscal_submit_case WHERE isReturn = '1' AND isReturnApproved = '1'";
$FiscalSqlResult = $conn->query($FiscalSql);

//OCC Cases SQL Query
$OCCSql = "SELECT * FROM v3_occ_case_assignment WHERE isReturn = '1' AND isReturnApproved = '1'";
$OCCSqlResult = $conn->query($OCCSql);

//RTC Cases SQL Query
$RTCSql = "SELECT * FROM v4_rtc_submit_warrant WHERE isReturn = '1' AND isReturnApproved = '1'";
$RTCSqlResult = $conn->query($RTCSql);

//Penalties
$penaltiesSql = "SELECT * FROM penalties WHERE EmployeeId='$loggedInEmployeeId'";
$penaltiesResult = $conn->query($penaltiesSql);
...
<body class="bg-gray-200">
    <!-- MOBILE SIDE -->
    <div>
        <nav class="lg:hidden py-6 px-6 bg-white shadow-md">
            <div class="flex items-center justify-between">
                <a class="flex items-center text-white font-semibold" href="#">
                    <img class="h-10" src="../../images/CourtFlowLogo.png" alt="" width="auto">
                    <span class="text-lg font-bold ml-2 text-indigo-300">CourtFlow</span>
                </a>
            ...
            <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-3/4 lg:w-80 sm:max-w-xs pt-6 pb-8 bg-white overflow-y-auto border-l border-gray-400 shadow-2xl">
                ...
                <div class="px-4 pb-6">
                    <?php if (!empty($loggedInRole)) : ?>
                        <h3 class="mb-2 text-xs uppercase text-gray-500 font-medium">User Dashboard <?php echo $loggedInEmployeeId; ?></h3>
                    <?php endif; ?>
                    <ul class="text-sm font-medium">
                        <li>
                            <a href="userDashboard.php" class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded">
                                <span class="inline-block mr-3">
                                    <svg class="w-5 h-5 hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <li class="<?php echo ($CaseHistory === 0) ? 'hidden' : ''; ?>">
                            <a href="userCaseHistory.php" class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded">
                                <span class="inline-block mr-3">
                        ...
                        <li class="<?php echo ($RetrievedDocuments === 0) ? 'hidden' : ''; ?>">
                            <a class="flex items-center pl-3 py-3 pr-2 text-gray-50 bg-gray-900 rounded">
                                <span class="inline-block mr-3">
                        ...
                        <li class="<?php echo ($SentCases === 0) ? 'hidden' : ''; ?>">
                            <a class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded" href="userSentCases.php">
                                <span class="inline-block mr-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <li class="<?php echo ($RetrievedCases === 0) ? 'hidden' : ''; ?>">
                            <a class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded" href="userRetrievedCases.php">
                                <span class="inline-block mr-3">
                        ...
                        <li class="<?php echo ($WarrantArrest === 0) ? 'hidden' : ''; ?>">
                            <a class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded" href="userWarrant.php">
                                <span class="inline-block mr-3">
                                    <svg class="w-5 h-5" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.8802 1.66663H4.2135C3.55068 1.66735 2.91522 1.93097 2.44653 2.39966C1.97785 2.86834 1.71422 3.50381 1.7135 4.16663V15.8333C1.71422 16.4961 1.97785 17.1316 2.44653 17.6003C2.91522 18.0689 3.55068 18.3326 4.2135 18.3333H15.8802C16.543 18.3326 17.1785 18.0689 17.6471 17.6003C18.1158 17.1316 18.3794 16.4961 18.3802 15.8333V4.16663C18.3794 3.50381 18.1158 2.86834 17.6471 2.39966C17.1785 1.93097 16.543 1.66735 15.8802 1.66663ZM4.2135 3.33329H15.8802C16.1011 3.33351 16.3129 3.42138 16.4692 3.57761C16.6254 3.73385 16.7133 3.94568 16.7135 4.16663V10.8333H14.6595C14.385 10.8331 14.1148 10.9007 13.8729 11.0302C13.6309 11.1597 13.4248 11.347 13.2728 11.5755L12.1009 13.3333H7.9928L6.82093 11.5755C6.6689 11.347 6.46273 11.1597 6.22079 11.0302C5.97884 10.9007 5.70863 10.8331 5.43421 10.8333H3.38017V4.16663C3.38039 3.94568 3.46826 3.73385 3.62449 3.57761C3.78072 3.42138 3.99255 3.33351 4.2135 3.33329ZM15.8802 16.6666H4.2135C3.99255 16.6664 3.78072 16.5785 3.62449 16.4223C3.46826 16.2661 3.38039 16.0542 3.38017 15.8333V12.5H5.43421L6.60608 14.2578C6.75811 14.4862 6.96428 14.6736 7.20622 14.803C7.44817 14.9325 7.71838 15.0002 7.9928 15H12.1009C12.3753 15.0002 12.6455 14.9325 12.8875 14.803C13.1294 14.6736 13.3356 14.4862 13.4876 14.2578L14.6595 12.5H16.7135V15.8333C16.7133 16.0542 16.6254 16.2661 16.4692 16.4223C16.3129 16.5785 16.1011 16.6664 15.8802 16.6666Z" fill="currentColor"></path>
                                    </svg>
                        ...
                        <li class="<?php echo ($Archived === 0) ? 'hidden' : ''; ?>">
                            <a class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded" href="userArchived.php">
                                <span class="inline-block mr-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <li class="<?php echo ($ScheduledHearing === 0) ? 'hidden' : ''; ?>">
                            <a class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded" href="userSchedule.php">
                                <span class="inline-block mr-3">
                                    <svg class="w-5 h-5" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.8802 1.66663H4.2135C3.55068 1.66735 2.91522 1.93097 2.44653 2.39966C1.97785 2.86834 1.71422 3.50381 1.7135 4.16663V15.8333C1.71422 16.4961 1.97785 17.1316 2.44653 17.6003C2.91522 18.0689 3.55068 18.3326 4.2135 18.3333H15.8802C16.543 18.3326 17.1785 18.0689 17.6471 17.6003C18.1158 17.1316 18.3794 16.4961 18.3802 15.8333V4.16663C18.3794 3.50381 18.1158 2.86834 17.6471 2.39966C17.1785 1.93097 16.543 1.66735 15.8802 1.66663ZM4.2135 3.33329H15.8802C16.1011 3.33351 16.3129 3.42138 16.4692 3.57761C16.6254 3.73385 16.7133 3.94568 16.7135 4.16663V10.8333H14.6595C14.385 10.8331 14.1148 10.9007 13.8729 11.0302C13.6309 11.1597 13.4248 11.347 13.2728 11.5755L12.1009 13.3333H7.9928L6.82093 11.5755C6.6689 11.347 6.46273 11.1597 6.22079 11.0302C5.97884 10.9007 5.70863 10.8331 5.43421 10.8333H3.38017V4.16663C3.38039 3.94568 3.46826 3.73385 3.62449 3.57761C3.78072 3.42138 3.99255 3.33351 4.2135 3.33329ZM15.8802 16.6666H4.2135C3.99255 16.6664 3.78072 16.5785 3.62449 16.4223C3.46826 16.2661 3.38039 16.0542 3.38017 15.8333V12.5H5.43421L6.60608 14.2578C6.75811 14.4862 6.96428 14.6736 7.20622 14.803C7.44817 14.9325 7.71838 15.0002 7.9928 15H12.1009C12.3753 15.0002 12.6455 14.9325 12.8875 14.803C13.1294 14.6736 13.3356 14.4862 13.4876 14.2578L14.6595 12.5H16.7135V15.8333C16.7133 16.0542 16.6254 16.2661 16.4692 16.4223C16.3129 16.5785 16.1011 16.6664 15.8802 16.6666Z" fill="currentColor"></path>
                                    </svg>
                        ...
                        <li class="<?php echo ($Documents === 0) ? 'hidden' : ''; ?>">
                            <a class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded" href="userDocuments.php">
                                <span class="inline-block mr-3">
                                    <svg class="w-5 h-5" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.8802 1.66663H4.2135C3.55068 1.66735 2.91522 1.93097 2.44653 2.39966C1.97785 2.86834 1.71422 3.50381 1.7135 4.16663V15.8333C1.71422 16.4961 1.97785 17.1316 2.44653 17.6003C2.91522 18.0689 3.55068 18.3326 4.2135 18.3333H15.8802C16.543 18.3326 17.1785 18.0689 17.6471 17.6003C18.1158 17.1316 18.3794 16.4961 18.3802 15.8333V4.16663C18.3794 3.50381 18.1158 2.86834 17.6471 2.39966C17.1785 1.93097 16.543 1.66735 15.8802 1.66663ZM4.2135 3.33329H15.8802C16.1011 3.33351 16.3129 3.42138 16.4692 3.57761C16.6254 3.73385 16.7133 3.94568 16.7135 4.16663V10.8333H14.6595C14.385 10.8331 14.1148 10.9007 13.8729 11.0302C13.6309 11.1597 13.4248 11.347 13.2728 11.5755L12.1009 13.3333H7.9928L6.82093 11.5755C6.6689 11.347 6.46273 11.1597 6.22079 11.0302C5.97884 10.9007 5.70863 10.8331 5.43421 10.8333H3.38017V4.16663C3.38039 3.94568 3.46826 3.73385 3.62449 3.57761C3.78072 3.42138 3.99255 3.33351 4.2135 3.33329ZM15.8802 16.6666H4.2135C3.99255 16.6664 3.78072 16.5785 3.62449 16.4223C3.46826 16.2661 3.38039 16.0542 3.38017 15.8333V12.5H5.43421L6.60608 14.2578C6.75811 14.4862 6.96428 14.6736 7.20622 14.803C7.44817 14.9325 7.71838 15.0002 7.9928 15H12.1009C12.3753 15.0002 12.6455 14.9325 12.8875 14.803C13.1294 14.6736 13.3356 14.4862 13.4876 14.2578L14.6595 12.5H16.7135V15.8333C16.7133 16.0542 16.6254 16.2661 16.4692 16.4223C16.3129 16.5785 16.1011 16.6664 15.8802 16.6666Z" fill="currentColor"></path>
                                    </svg>
                    ...
                    <div class="pt-8">
                        ...
                        <form action="../../controller/logout.php" method="post">
                            <a class="flex items-center pl-3 py-3 pr-2 text-gray-500 hover:bg-gray-700 hover:text-white transition duration-300 border-gray-500 rounded">
                                <span class="inline-block mr-4">
                                    <svg class="hover:text-white w-5 h-5" viewbox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <?php if ($loggedInRole === "PAO") : ?>
        <div class="py-20 ml-40 mr-5 pl-44">
            ...
            <!--PAO edit form-->
            <div id="PaoEditFormContainer" class="hidden">
                <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                    <form id="PaoEditForm" action="../../controller/user_RetrievedDocumentsController.php" method="post" enctype="multipart/form-data" class="bg-white p-6 rounded-md">
                        <input type="hidden" name="id" id="id">
                        <input type="hidden" name="returnId" id="returnId">
                       <label for="complainantFullName" class="text-sm">Complainant Name</label>
                       <div id="complainantFullName" class="flex flex-row">
                            <!--Last Name-->
                            <div id="ComplainantLastName" class="w-1/2 mr-1">
                                <label for="ComplainantLastName" class="text-sm">Last Name</label>
                                <br />
                                <input required type="text" name="ComplainantLastName" id="ComplainantLastName" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                            </div>
                            <!--First Name-->
                            <div id="ComplainantFirstName" class="w-1/2 mr-1">
                                <label for="ComplainantFirstName" class="text-sm">First Name</label>
                                <br />
                                <input required type="text" name="ComplainantFirstName" id="ComplainantFirstName" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                            </div>
                            <!--Middle Name-->
                            <div id="ComplainantMiddleName" class="w-1/2 mr-1">
                                <label for="ComplainantMiddleName" class="text-sm">Middle Name</label>
                                <br />
                                <input required type="text" name="ComplainantMiddleName" id="ComplainantMiddleName" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                            </div>
                        </div>
                        
                        <p class="text-sm mt-5">Accused Name </p>
                        <div id="accusedFullName" class="flex flex-row">
                            <!--Last Name-->
                            <div id="AccusedLastName" class="w-1/2 mr-1">
                                <label for="AccusedLastName" class="text-sm">Last Name</label>
                                <br />
                                <input required type="text" name="AccusedLastName" id="AccusedLastName" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                            </div>
                            <!--First Name-->
                            <div id="AccusedFirstName" class="w-1/2 mr-1">
                                <label for="AccusedFirstName" class="text-sm">First Name</label>
                                <br />
                                <input required type="text" name="AccusedFirstName" id="AccusedFirstName" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                            </div>
                            <!--Middle Name-->
                            <div id="AccusedMiddleName" class="w-1/2 mr-1">
                                <label for="AccusedMiddleName" class="text-sm">Middle Name</label>
                                <br />
                                <input required type="text" name="AccusedMiddleName" id="AccusedMiddleName" class="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent outline-blue-600 shadow-sm" />
                            </div>
                        </div>
                        
                        <div class="mt-5">
                            <input required type='file' name="file" accept=".doc, .docx"/>
                        </div>
                        <div class="mt-5">
                            <button type="submit" name="PaoEditSubmitButton" id="PaoEditSubmitButton" class="mt-5 flex w-full justify-center rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm bg-gray-900  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Submit
                            </button>
                        </div>
                        <div class="mt-5">
                            <button type="button" name="PaoEditBackButton" id="PaoEditBackButton" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Back
                            </button>
                        </div>
                    </form>
            ...
            <!--View PAO Reason Form-->
            <div id="viewPAOReasonFormContainer" class="hidden">
                <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                    <form id="viewPAOReasonForm" class="bg-white p-6 rounded-md">
                        <div class="mt-2">
                            <textarea readonly class="h-72 w-96 resize-none border rounded-md p-2" name="reason" id="reason"></textarea>
                        </div>
                        <div>
                            <button type="button" name="viewPAOReasonBackButton" id="viewPAOReasonBackButton" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Back
                            </button>
                        </div>
                    </form>
            ...
            <table class="mt-5 table-auto w-full border-b border-gray-900 bg-gray-600 shadow-2xl rounded-lg">
                <thead class="border-b-2 border-gray-900">
                    <tr>
                        <th class="pl-6 py-6">
                            <p class="flex items-center text-xs text-white">From</p>
                        </th>
                        <th>
                            <p class="flex items-center text-xs text-white">Complainant Name</p>
                        </th>
                        <th>
                            <p class="flex items-center text-xs text-white">Accused Name</p>
                        </th>
                        <th>
                            <p class="flex items-center text-xs text-white">Date Submitted</p>
                        </th>
                        <th>
                            <p class="flex items-center text-xs text-white">File</p>
                        </th>
                        <th>
                            <p class="flex items-center text-xs text-white">Reason</p>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    ?>
                        <tr class="text-xs bg-blue-50 border-b border-gray-100 edit-trigger">
                            ...
                            <td class="pl-6 py-6 hidden">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT id FROM returns WHERE CaseId = ?");
                                    $stmt->bind_param("i", $CaseId);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
                                    $userData = $result->fetch_assoc();
                                    $returnId = $userData['id'];
                            ...
                            <td class="pl-6 py-6 bg-blue-100">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT FromEmployee FROM returns WHERE CaseId = ?");
                                    $stmt->bind_param("i", $CaseId);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
                                    $userData = $result->fetch_assoc();
                                    $FromEmployee = $userData['FromEmployee'];
                
                                    echo $FromEmployee;
                                ?>
                            </td>
                            <td class="pl-6 py-6 hidden"><?= $PAOCases['complainantLName']; ?></td>
                            <td class="pl-6 py-6 hidden"><?= $PAOCases['complainantFName']; ?></td>
                            <td class="pl-6 py-6 hidden"><?= $PAOCases['complainantMName']; ?></td>
                            <td class="pl-6 py-6 hidden"><?= $PAOCases['accusedLName']; ?></td>
                            <td class="pl-6 py-6 hidden"><?= $PAOCases['accusedFName']; ?></td>
                            <td class="pl-6 py-6 hidden"><?= $PAOCases['accusedMName']; ?></td>
                            <td class="pl-6 py-6"><?= $PAOCases['complainantLName'] . ", " . $PAOCases['complainantFName'] . " " . $PAOCases['complainantMName']; ?></td>
                            <td class="pl-6 py-6 bg-blue-100"><?= $PAOCases['accusedLName'] . ", " . $PAOCases['accusedFName'] . " " . $PAOCases['accusedMName']; ?></td>
                            <td class="pl-6 py-6"><?= $PAOCases['Date']; ?></td>
                            <td class="pl-6 py-6 hidden">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT Reason FROM returns WHERE CaseId = ?");
                                    $stmt->bind_param("i", $CaseId);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
                                    $userData = $result->fetch_assoc();
                            ...
                            <td class="pl-6 py-6 bg-blue-100">
                                <a href="../../controller/user_RetrievedDocumentsController.php?PAOViewFile=<?= $PAOCases['id']; ?>"> View
                                </a>
                            </td>
                            <td class="pl-6 py-6">
                                <button class="PaoView-button">
                                    View
                                </button>
                            </td>
                            <td class="pl-6 py-6 bg-blue-100">
                                <button class="PaoEdit-button">
                                    Edit
                                </button>
                            </td>
                        </tr>
    ...
    <?php if ($loggedInRole === "Fiscal") : ?>
        <div class="py-20 ml-40 mr-5 pl-44">
            ...
            <!--Fiscal edit form-->
            <div id="FiscalEditFormContainer" class="hidden">
                <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                    <form id="FiscalEditForm" action="../../controller/user_RetrievedDocumentsController.php" method="post" enctype="multipart/form-data" class="bg-white p-6 rounded-md">
                        <input type="hidden" name="id" id="id">
                        <input type="hidden" name="returnId" id="returnId">

                        <label for="penalty" class="text-gray-700 font-semibold">Penalty</label>
                            <select name="penalty" id="penalty" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900">
                                <?php foreach ($penaltiesResult as $penalties) : ?>
                                    <option value="<?= $penalties['id']; ?>"><?= "Republic Act " . $penalties['RepublicAct'] . ", Article " . $penalties['Article'] . ", Section " . $penalties['Section']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="mt-5">
                            <button type="submit" name="FiscalEditSubmitButton" id="FiscalEditSubmitButton" class="mt-5 flex w-full justify-center rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm bg-gray-900  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Submit
                            </button>
                        </div>
                        <div class="mt-5">
                            <button type="button" name="FiscalEditBackButton" id="FiscalEditBackButton" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Back
                            </button>
                        </div>
                    </form>
            ...
            <!--View Fiscal Reason Form-->
            <div id="viewFiscalReasonFormContainer" class="hidden">
                <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                    <form id="viewFiscalReasonForm" class="bg-white p-6 rounded-md">
                        <div class="mt-2">
                            <textarea readonly class="h-72 w-96 resize-none border rounded-md p-2" name="reason" id="reason"></textarea>
                        </div>
                        <div>
                            <button type="button" name="viewFiscalReasonBackButton" id="viewFiscalReasonBackButton" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Back
                            </button>
                        </div>
                    </form>
            ...
            <table class="mt-5 table-auto w-full border-b border-gray-900 bg-gray-600 shadow-2xl rounded-lg">
                <thead class="border-b-2 border-gray-900">
                    <tr>
                        ...
                        <th>
                            <p class="flex items-center text-xs text-white">Penalty</p>
                        </th>
                        <th>
                            <p class="flex items-center text-xs text-white">Date Submitted</p>
                        </th>
                    ...
                    ?>
                        <tr class="text-xs bg-blue-50 border-b border-gray-100 edit-trigger">
                            ...
                            <td class="pl-6 py-6 hidden">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT id FROM returns WHERE CaseId = ? AND Version = ?");
                            ...
                            <td class="pl-6 py-6 bg-blue-100">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT FromEmployee FROM returns WHERE CaseId = ? AND Version = ?");
                                    $stmt->bind_param("ii", $CaseId, $Version);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
                                    $userData = $result->fetch_assoc();
                            ...
                            <td class="pl-6 py-6"><?= $FiscalCases['Penalty']; ?></td>
                            <td class="pl-6 py-6 bg-blue-100"><?= $FiscalCases['DateSubmitted']; ?></td>
                            <td class="pl-6 py-6 hidden">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT Reason FROM returns WHERE CaseId = ? AND Version = ?");
                                    $stmt->bind_param("ii", $CaseId, $Version);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
                                    $userData = $result->fetch_assoc();
                            ...
                            <td class="pl-6 py-6">
                                <a href="../../controller/user_RetrievedDocumentsController.php?FiscalViewFile=<?= $FiscalCases['id']; ?>"> View
                                </a>
                            </td>
                            <td class="pl-6 py-6 bg-blue-100">
                                <button class="FiscalView-button">
                                    View
                                </button>
                            </td>
                            <td class="pl-6 py-6">
                                <button class="FiscalEdit-button">
                                    Edit
                                </button>
                            </td>
                        </tr>
    ...
    <?php if ($loggedInRole === "OCC") : ?>
        <div class="py-20 ml-40 mr-5 pl-44">
            ...
            <!--OCC edit form-->
            <div id="OCCEditFormContainer" class="hidden">
                <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                    <form id="OCCEditForm" action="../../controller/user_RetrievedDocumentsController.php" method="post" enctype="multipart/form-data" class="bg-white p-6 rounded-md">
                        <input type="hidden" name="id" id="id">
                        <input type="hidden" name="returnId" id="returnId">
                        ...
                        <div class="mt-5">
                            <button type="submit" name="OCCEditSubmitButton" id="OCCEditSubmitButton" class="mt-5 flex w-full justify-center rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm bg-gray-900  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Submit
                            </button>
                        </div>
                        <div class="mt-5">
                            <button type="button" name="OCCEditBackButton" id="OCCEditBackButton" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Back
                            </button>
                        </div>
                    </form>
            ...
            <!--View OCC Reason Form-->
            <div id="viewOCCReasonFormContainer" class="hidden">
                <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                    <form id="viewOCCReasonForm" class="bg-white p-6 rounded-md">
                        <div class="mt-2">
                            <textarea readonly class="h-72 w-96 resize-none border rounded-md p-2" name="reason" id="reason"></textarea>
                        </div>
                        <div>
                            <button type="button" name="viewOCCReasonBackButton" id="viewOCCReasonBackButton" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Back
                            </button>
                        </div>
                    </form>
            ...
            <table class="mt-5 table-auto w-full border-b border-gray-900 bg-gray-600 shadow-2xl rounded-lg">
                <thead class="border-b-2 border-gray-900">
                    <tr>
                        ...
                        <th>
                            <p class="flex items-center text-xs text-white">Docket Number</p>
                        </th>
                        <th>
                            <p class="flex items-center text-xs text-white">Date Submitted</p>
                        </th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="text-xs bg-blue-50 border-b border-gray-100 edit-trigger">
                            ...
                            <td class="pl-6 py-6"><?= $occCases['DocketNumber']; ?></td>
                            <td class="pl-6 py-6 bg-blue-100"><?= $occCases['DateSubmitted']; ?></td>
                            <td class="pl-6 py-6 hidden">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT Reason FROM returns WHERE CaseId = ? AND Version = ?");
                            ...
                            <td class="pl-6 py-6">
                                <a href="../../controller/user_RetrievedDocumentsController.php?OCCViewFile=<?= $occCases['id']; ?>"> View
                                </a>
                            </td>
                            <td class="pl-6 py-6 bg-blue-100">
                                <button class="OCCView-button">
                                    View
                                </button>
                            </td>
                            <td class="pl-6 py-6">
                                <button class="OCCEdit-button">
                                    Edit
                                </button>
                            </td>
                        </tr>
    ...
    <?php if ($loggedInRole === "RTC") : ?>
        <div class="py-20 ml-40 mr-5 pl-44">
            ...
            <!--RTC edit form-->
            <div id="RTCEditFormContainer" class="hidden">
                <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                    <form id="RTCEditForm" action="../../controller/user_RetrievedDocumentsController.php" method="post" enctype="multipart/form-data" class="bg-white p-6 rounded-md">
                        <input type="hidden" name="id" id="id">
                        <input type="hidden" name="returnId" id="returnId">
                        ...
                        <div class="mt-5">
                            <button type="submit" name="RTCEditSubmitButton" id="RTCEditSubmitButton" class="mt-5 flex w-full justify-center rounded-md px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm bg-gray-900  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Submit
                            </button>
                        </div>
                        <div class="mt-5">
                            <button type="button" name="RTCEditBackButton" id="RTCEditBackButton" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Back
                            </button>
                        </div>
                    </form>
            ...
            <!--View RTC Reason Form-->
            <div id="viewRTCReasonFormContainer" class="hidden">
                <div class="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
                    <form id="viewRTCReasonForm" class="bg-white p-6 rounded-md">
                        <div class="mt-2">
                            <textarea readonly class="h-72 w-96 resize-none border rounded-md p-2" name="reason" id="reason"></textarea>
                        </div>
                        <div>
                            <button type="button" name="viewRTCReasonBackButton" id="viewRTCReasonBackButton" class="mt-5 flex w-full justify-center rounded-md bg-gray-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Back
                            </button>
                        </div>
                    </form>
            ...
            <table class="mt-5 table-auto w-full border-b border-gray-900 bg-gray-600 shadow-2xl rounded-lg">
                ...
                <tbody>
                    <?php
                    foreach ($RTCSqlResult as $RTCCases) :
                        $CaseId = $RTCCases['id'];
                        $Version = 4;
                    ?>
                        <tr class="text-xs bg-blue-50 border-b border-gray-100 edit-trigger">
                            <td class="hidden"><?= $RTCCases['id']; ?></td>
                            <td class="pl-6 py-6 hidden">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT id FROM returns WHERE CaseId = ? AND Version = ?");
                            ...
                            <td class="pl-6 py-6"><?= $RTCCases['DocketNumber']; ?></td>
                            <td class="pl-6 py-6 bg-blue-100"><?= $RTCCases['DateSubmitted']; ?></td>
                            <td class="pl-6 py-6 hidden">
                                <?php 
                                    // Retrieve the returns Reason
                                    $stmt = $conn->prepare("SELECT Reason FROM returns WHERE CaseId = ? AND Version = ?");
                            ...
                            <td class="pl-6 py-6">
                                <a href="../../controller/user_RetrievedDocumentsController.php?RTCViewFile=<?= $RTCCases['id']; ?>"> View
                                </a>
                            </td>
                            <td class="pl-6 py-6 bg-blue-100">
                                <button class="RTCView-button">
                                    View
                                </button>
                            </td>
                            <td class="pl-6 py-6">
                                <button class="RTCEdit-button">
                                    Edit
                                </button>
                            </td>
                        </tr>
...
<script>
const PaoEditButtons = document.querySelectorAll(".PaoEdit-button");
const PaoEditFormContainer = document.getElementById("PaoEditFormContainer");
const PaoEditForm = document.getElementById("PaoEditForm");
const PaoEditBackButton = document.getElementById("PaoEditBackButton");

PaoEditButtons.forEach((PaoEditButton) => {
    PaoEditButton.addEventListener("click", () => {
      
      PaoEditFormContainer.classList.remove("hidden");
  
      const tableRow = PaoEditButton.closest("tr");
      
      const id = tableRow.cells[0].textContent;
      const returnId = tableRow.cells[1].textContent;
      const ComplainantLastName = tableRow.cells[3].textContent;
      const ComplainantFirstName = tableRow.cells[4].textContent;
      const ComplainantMiddleName = tableRow.cells[5].textContent;
      const AccusedLastName = tableRow.cells[6].textContent;
      const AccusedFirstName = tableRow.cells[7].textContent;
      const AccusedMiddleName = tableRow.cells[8].textContent;
      
      PaoEditForm.id.value = id;
      PaoEditForm.returnId.value = returnId;
      PaoEditForm.ComplainantLastName.value = ComplainantLastName;
      PaoEditForm.ComplainantFirstName.value = ComplainantFirstName;
      PaoEditForm.ComplainantMiddleName.value = ComplainantMiddleName;
      PaoEditForm.AccusedLastName.value = AccusedLastName;
      PaoEditForm.AccusedFirstName.value = AccusedFirstName;
      PaoEditForm.AccusedMiddleName.value = AccusedMiddleName;
      
    });
  });

  PaoEditBackButton.addEventListener("click", () => {
    PaoEditFormContainer.classList.add("hidden");
});

const viewPAOReasonButtons = document.querySelectorAll(".PaoView-button");
const viewPAOReasonFormContainer = document.getElementById("viewPAOReasonFormContainer");
const viewPAOReasonForm = document.getElementById("viewPAOReasonForm");
const viewPAOReasonBackButton = document.getElementById("viewPAOReasonBackButton");

viewPAOReasonButtons.forEach((viewPAOReasonButton) => {
    viewPAOReasonButton.addEventListener("click", () => {
      
      viewPAOReasonFormContainer.classList.remove("hidden");
  
      
      const tableRow = viewPAOReasonButton.closest("tr");
  
      
      const Reason = tableRow.cells[12].textContent;
  
      
      viewPAOReasonForm.reason.value = Reason;

      
    });
  });

  viewPAOReasonBackButton.addEventListener("click", () => {
    viewPAOReasonFormContainer.classList.add("hidden");
});
</script>

<script>
const FiscalEditButtons = document.querySelectorAll(".FiscalEdit-button");
const FiscalEditFormContainer = document.getElementById("FiscalEditFormContainer");
const FiscalEditForm = document.getElementById("FiscalEditForm");
const FiscalEditBackButton = document.getElementById("FiscalEditBackButton");

FiscalEditButtons.forEach((FiscalEditButton) => {
    FiscalEditButton.addEventListener("click", () => {
      
      FiscalEditFormContainer.classList.remove("hidden");
  
      const tableRow = FiscalEditButton.closest("tr");
      
      const id = tableRow.cells[0].textContent;
      const returnId = tableRow.cells[1].textContent;
      const penalty = tableRow.cells[3].textContent;
      
      FiscalEditForm.id.value = id;
      FiscalEditForm.returnId.value = returnId;
      FiscalEditForm.penalty.value = penalty;
      
    });
  });

  FiscalEditBackButton.addEventListener("click", () => {
    FiscalEditFormContainer.classList.add("hidden");
});

const viewFiscalReasonButtons = document.querySelectorAll(".FiscalView-button");
const viewFiscalReasonFormContainer = document.getElementById("viewFiscalReasonFormContainer");
const viewFiscalReasonForm = document.getElementById("viewFiscalReasonForm");
const viewFiscalReasonBackButton = document.getElementById("viewFiscalReasonBackButton");

viewFiscalReasonButtons.forEach((viewFiscalReasonButton) => {
    viewFiscalReasonButton.addEventListener("click", () => {
      
      viewFiscalReasonFormContainer.classList.remove("hidden");
  
      
      const tableRow = viewFiscalReasonButton.closest("tr");
  
      
      const Reason = tableRow.cells[5].textContent;
  
      
      viewFiscalReasonForm.reason.value = Reason;

      
    });
  });

  viewFiscalReasonBackButton.addEventListener("click", () => {
    viewFiscalReasonFormContainer.classList.add("hidden");
});
</script>

<script>
const OCCEditButtons = document.querySelectorAll(".OCCEdit-button");
const OCCEditFormContainer = document.getElementById("OCCEditFormContainer");
const OCCEditForm = document.getElementById("OCCEditForm");
const OCCEditBackButton = document.getElementById("OCCEditBackButton");

OCCEditButtons.forEach((OCCEditButton) => {
    OCCEditButton.addEventListener("click", () => {
      
      OCCEditFormContainer.classList.remove("hidden");
  
      const tableRow = OCCEditButton.closest("tr");
      
      const id = tableRow.cells[0].textContent;
      const returnId = tableRow.cells[1].textContent;
      const penalty = tableRow.cells[3].textContent;
      
      OCCEditForm.id.value = id;
      OCCEditForm.returnId.value = returnId;
      
    });
  });

  OCCEditBackButton.addEventListener("click", () => {
    OCCEditFormContainer.classList.add("hidden");
});

const viewOCCReasonButtons = document.querySelectorAll(".OCCView-button");
const viewOCCReasonFormContainer = document.getElementById("viewOCCReasonFormContainer");
const viewOCCReasonForm = document.getElementById("viewOCCReasonForm");
const viewOCCReasonBackButton = document.getElementById("viewOCCReasonBackButton");

viewOCCReasonButtons.forEach((viewOCCReasonButton) => {
    viewOCCReasonButton.addEventListener("click", () => {
      
      viewOCCReasonFormContainer.classList.remove("hidden");
  
      
      const tableRow = viewOCCReasonButton.closest("tr");
  
      
      const Reason = tableRow.cells[5].textContent;
  
      
      viewOCCReasonForm.reason.value = Reason;

      
    });
  });

  viewOCCReasonBackButton.addEventListener("click", () => {
    viewOCCReasonFormContainer.classList.add("hidden");
});
</script>

<script>
const RTCEditButtons = document.querySelectorAll(".RTCEdit-button");
const RTCEditFormContainer = document.getElementById("RTCEditFormContainer");
const RTCEditForm = document.getElementById("RTCEditForm");
const RTCEditBackButton = document.getElementById("RTCEditBackButton");

RTCEditButtons.forEach((RTCEditButton) => {
    RTCEditButton.addEventListener("click", () => {
      
      RTCEditFormContainer.classList.remove("hidden");
  
      const tableRow = RTCEditButton.closest("tr");
      
      const id = tableRow.cells[0].textContent;
      const returnId = tableRow.cells[1].textContent;
      const penalty = tableRow.cells[3].textContent;
      
      RTCEditForm.id.value = id;
      RTCEditForm.returnId.value = returnId;
      
    });
  });

  RTCEditBackButton.addEventListener("click", () => {
    RTCEditFormContainer.classList.add("hidden");
});

const viewRTCReasonButtons = document.querySelectorAll(".RTCView-button");
const viewRTCReasonFormContainer = document.getElementById("viewRTCReasonFormContainer");
const viewRTCReasonForm = document.getElementById("viewRTCReasonForm");
const viewRTCReasonBackButton = document.getElementById("viewRTCReasonBackButton");

viewRTCReasonButtons.forEach((viewRTCReasonButton) => {
    viewRTCReasonButton.addEventListener("click", () => {
      
      viewRTCReasonFormContainer.classList.remove("hidden");
  
      
      const tableRow = viewRTCReasonButton.closest("tr");
  
      
      const Reason = tableRow.cells[5].textContent;
  
      
      viewRTCReasonForm.reason.value = Reason;

      
    });
  });

  viewRTCReasonBackButton.addEventListener("click", () => {
    viewRTCReasonFormContainer.classList.add("hidden");
});
</script>

<!-- <script src="../../javascript/user_retrievedDocuments.js"></script> -->