<template>
 ...
 <div class="min-h-screen w-full bg-gray-50 !pl-0 text-left sm:!pl-60" id="content">
  ...
  <!-- Search Bar -->
  <div class="mt-4">
  <h1 class="text-2xl font-semibold mb-4 text-purple-800">Warrant of Arrest</h1>
             </div>
             <!-- Search Bar -->
             <div class="mt-4">
                 ...
                 <table class="w-full border bg-black-300">
                     <thead>
                         <tr>
                             ...
                             <th class="border p-2">Warrant of Arrest Status</th>
                         </tr>
                     </thead>
                     <tbody>
                         ...
                         <tr class="hover:bg-gray-100">
                             ...
                             <td class="border p-2">Bunawan Aplaya</td>
                             <td class="border p-2">Murder</td>
                             <td class="border p-2">Standing</td>
                         </tr>
                         <tr class="hover:bg-gray-100">
