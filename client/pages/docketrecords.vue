<template>
 ...
 <div class="min-h-screen w-full bg-gray-50 !pl-0 text-left sm:!pl-60" id="content">
  ...
  <!-- Search Bar -->
  <div class="mt-4">
  <h1 class="text-2xl font-semibold mb-4 text-purple-800">Docket Tracing</h1>
             </div>
             <!-- Search Bar -->
             <div class="mt-4">
             ...
             <div class="w-15 bg-white p-6 shadow-md mt-4 border rounded-md shadow-lg">
                 <table class="w-full border bg-black-300">
                     <thead>
                         <tr>
                             <th class="border p-2">Docket Number</th>
                     ...
                     <tbody>
                         ...
                         <tr class="hover:bg-gray-100">
                             ...
                             <td class="border p-2">Branch 16</td>
                         </tr>
                         <tr class="hover:bg-gray-100">
                             <td class="border p-2">002</td>
                             <td class="border p-2">Illegal Possesion of Drugs</td>
                             <td class="border p-2">Branch 10</td>
                         </tr>
                         <tr class="hover:bg-gray-100">
                             <td class="border p-2">003</td>
                             <td class="border p-2">Carnaping</td>
                             <td class="border p-2">Branch 11</td>
                         </tr>
                         <tr class="hover:bg-gray-100">
                             <td class="border p-2">004</td>
                             <td class="border p-2">Theft</td>
                             <td class="border p-2">Branch 10</td>
                         </tr>
                     </tbody>
                 </table>
