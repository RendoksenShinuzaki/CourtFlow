<template>
    ...
    <div class="min-h-screen w-full bg-gray-50 !pl-0 text-center sm:!pl-60" id="content">
      <div class="py-12 -20">
        <h1 class="text-2xl font-semibold mb-4 text-purple-800">Document Forwarding</h1>
      </div>
  
      <div class="mt-">
        <input v-model="searchQuery" class="w-72 p-2 border rounded-2xl shadow-lg" placeholder="Search Cases,..." 
        style="color: purple;">
      </div>


<!-- Case Detail -->
<div class="w-15 bg-white p-6 shadow-md mt-4 rounded-md">
