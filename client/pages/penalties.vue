<template>
       ...
       data-te-sidenav-menu-ref>
         ...
         <li class="relative">
           <a
             ...
             <span>Case Nature Penalties</span>
           </a>
         </li>
       </ul>
 ...
 <div class="min-h-screen w-full bg-gray-50 !pl-0 text-left sm:!pl-60" id="content">
  ...
  <!-- Search Bar -->
  <div class="mt-4">
  <h1 class="text-2xl font-semibold mb-4 text-purple-800">Case Nature Penalties</h1>
             </div>
             <!-- Search Bar -->
             <div class="mt-4">
             ...
             <div class="w-15 bg-white p-6 shadow-md mt-4 border rounded-md shadow-lg">
                 <table class="w-full border bg-black-300">
                     <thead>
                         <tr>
                             <th class="border p-2">CNID</th>
                             <th class="border p-2">Case Name</th>
                             <th class="border p-2">Case Fine</th>
                             <th class="border p-2">Bailable?</th>
                         </tr>
                     </thead>
                     <tbody>
                         ...
                         <tr class="hover:bg-gray-100">
                             ...
                             <td class="border p-2">REPUBLIC ACT NO. 9165</td>
                             <td class="border p-2">250,000 - 500,000</td>
                             <td class="border p-2">In Between</td>
                         </tr>
                         <tr class="hover:bg-gray-100">
                             <td class="border p-2">002</td>
                             <td class="border p-2">Article 266-B</td>
                             <td class="border p-2">------</td>
                             <td class="border p-2">No</td>
                         </tr>
                         <tr class="hover:bg-gray-100">
                             <td class="border p-2">003</td>
                             <td class="border p-2">Article 248</td>
                             <td class="border p-2">300,000</td>
                             <td class="border p-2">Yes</td>
                         </tr>
                         <tr class="hover:bg-gray-100">
                             <td class="border p-2">004</td>
                             <td class="border p-2">3019. Section 1</td>
                             <td class="border p-2">-----</td>
                             <td class="border p-2">No</td>
                         </tr>
                     </tbody>
