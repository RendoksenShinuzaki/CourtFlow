...
<div class="min-h-screen w-full bg-gray-50 !pl-0 text-center sm:!pl-60" id="content">
  <div class="py-12 -20">
    <h1 class="text-2xl font-semibold mb-4 text-purple-800">Admin Dashboard</h1>
  </div>


    <div class="flex">
      <a href="#" class="flex-1 w-40 p-4 m-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">10,000</h5>
          <p class="text-sm text-gray-700 dark:text-gray-400">Total Cases</p>
      </a>
      <a href="#" class="flex-1 w-40 p-4 m-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">5</h5>
          <p class="text-sm text-gray-700 dark:text-gray-400">Cases Solved</p>
      </a>
      <a href="#" class="flex-1 w-40 p-4 m-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">5</h5>
          <p class="text-sm text-gray-700 dark:text-gray-400">Transfered Cases</p>
      </a>
  </div>
      ...
      <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
        <div class="flex justify-between">
          <div>
            <p class="text-base font-normal text-gray-500 dark:text-gray-400">Pending Cases</p>
